...
class AdminSupportTicketControllerV1 extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return sendSuccessResponse("Support ticket created successfully", new AdminSupportTicketResourceV1($ticket));
    }

    public function show($ticketId)
    {
        $ticket = $this->ticketService->find($ticketId);
        return sendSuccessResponse("Support ticket retrieved successfully", new AdminSupportTicketResourceV1($ticket));
    }
    ...
    public function updateStatus(Request $request, $ticketId)
    {
        ...
        return sendSuccessResponse("Support ticket status updated successfully", new AdminSupportTicketResourceV1($ticket));
    }
}
